...
namespace ExamKing.Application.Services
{
    ...
    public class ExamService : IExamService, ITransient
    {
        ...
        public async Task<ExamDto> UpdateExam(ExamDto examDto)
        {
            ...
            await exam
                .UpdateExcludeNowAsync(new [] {"CreateTime"});
        ...
        public async Task<ExamDto> EnableExamById(int id)
        {
            ...
            exam.IsEnable = "1";
            await _examRepository.UpdateIncludeNowAsync(exam, new []{"IsEnable"});
            return exam.Adapt<ExamDto>();
        }
        ...
        public async Task<ExamDto> StartExamById(int id)
        {
            ...
            exam.IsFinish = "0";
            await _examRepository.UpdateIncludeNowAsync(exam, new []{"IsFinish"});
            return exam.Adapt<ExamDto>();
        }
        ...
        public async Task<StuscoreDto> SubmitExamByStudent(int id, int studentId)
        {
            ...
            foreach (var question in questions)
            {
                ...
                if (stuanswer == null)
                {
                    if (App.RootServices.GetService(typeof(IStuanswerdetailService)) is IStuanswerdetailService stuanswerdetailService)
                    {
